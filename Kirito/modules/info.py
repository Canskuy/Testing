...
from KiritoRobot import DEV_USERS, pbot
from KiritoRobot.utils.sections import section
...
@pbot.on_message(filters.command("uinfo"))
...
@pbot.on_message(filters.command("cinfo"))
