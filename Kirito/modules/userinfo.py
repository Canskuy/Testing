...
from KiritoRobot.__main__ import STATS, TOKEN, USER_INFO
from KiritoRobot.modules.sql import SESSION
import KiritoRobot.modules.sql.userinfo_sql as sql
...
from KiritoRobot.modules.sql.afk_sql import is_afk, set_afk
from KiritoRobot.modules.sql.users_sql import get_user_num_chats
from KiritoRobot.modules.helper_funcs.chat_status import sudo_plus
from KiritoRobot.modules.helper_funcs.extraction import extract_user
                    ...
                    [
                        [
                            InlineKeyboardButton(
                                "Health", url="https://t.me/kiritoupdate"),
                            InlineKeyboardButton(
                                "Disaster", url="https://t.me/kiritoupdate")
                        ],
                    ]
                ),
                parse_mode=ParseMode.HTML,
...
def stats(update: Update, context: CallbackContext):
    stats = "<b>╔═━「 Current Kirito Statistics 」</b>\n" + "\n".join([mod.__stats__() for mod in STATS])
