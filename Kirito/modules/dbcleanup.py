...
import KiritoRobot.modules.sql.global_bans_sql as gban_sql
import KiritoRobot.modules.sql.users_sql as user_sql
from KiritoRobot import DEV_USERS, OWNER_ID, dispatcher
