...
from KiritoRobot import pbot as app
from KiritoRobot import arq
from KiritoRobot.pyrogramee.keyboard import Ikb
from KiritoRobot.utils.pluginhelpers import (
    convert_seconds_to_minutes as time_convert,
    fetch,
)
from KiritoRobot.pyrogramee.tasks import _get_tasks_text, all_tasks, rm_task
from KiritoRobot.pyrogramee.types import InlineQueryResultCachedDocument
from KiritoRobot.modules.info import get_chat_info, get_user_info
from KiritoRobot.modules.music import download_youtube_audio
from KiritoRobot.utils.functions import test_speedtest
from KiritoRobot.utils.pastebin import paste
...
async def inline_help_func(__help__):
    ...
    answerss = [
        InlineQueryResultArticle(
            ...
            thumb_url="https://telegra.ph/file/1c1e03b8e734d5ba045a1.jpg",
...
async def alive_function(answers):
    ...
    msg = f"""
**[KiritoRobot ❤️](https://t.me/{BOT_USERNAME}):**
**RoBot:** `{bot_state}`
**UserBot:** `Alive`
...
**Profiles:** [BOT](https://t.me/{BOT_USERNAME}) | [UBOT](https://t.me/{OWNER_USERNAME})
"""
    answers.append(
        InlineQueryResultArticle(
            title="Alive",
            description="Check Kirito Stats",
            thumb_url="https://telegra.ph/file/1c1e03b8e734d5ba045a1.jpg",
            input_message_content=InputTextMessageContent(
...
async def about_function(answers):
    ...
    buttons.add(
        InlineKeyboardButton("sᴜᴘᴘᴏʀᴛ", url=f"https://t.me/kiritosupport"),
        InlineKeyboardButton("ᴄʜᴀɴɴᴇʟ", url=f"https://t.me/infoowlubot"),
    )

    msg = f"""
[Kirito Robot ✨](https://t.me/{BOT_USERNAME}) 
   Maintained by [can](t.me/{OWNER_USERNAME})
Built with using python-telegram-bot 13.7 Running on Python 3.9.7
"""
    answers.append(
        InlineQueryResultArticle(
            title="About",
            description="About Kirito Robot",
            thumb_url="https://telegra.ph/file/1c1e03b8e734d5ba045a1.jpg",
            input_message_content=InputTextMessageContent(
                msg, disable_web_page_preview=True
            ),
